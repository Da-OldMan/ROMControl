    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        switch (p.getClass().getSimpleName()) {
            case "SwitchPreference":
                ...
                } else if (key.equals("quick_connect_toggle")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("custom_carrier")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("statusbar_hide_alarm")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("bluetooth_icon")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("ticker_toggle")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("hide_ongoing_notif")) {
                    appRebootRequired("com.android.systemui");
                } else if (key.equals("next_alarm")) {
                    appRebootRequired("com.android.systemui");
                ...
                if (key.equals("launcher_rotation")) {
                    Command c = new Command(0, "pkill com.sec.android.app.launcher");
                    try {
                        RootTools.getShell(true).add(c);
                    } catch (IOException e) {
